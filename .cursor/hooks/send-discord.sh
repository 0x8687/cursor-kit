...
# Load environment variables with priority: process.env > .cursor/.env > .cursor/hooks/.env
load_env() {
    # 1. Start with lowest priority: .cursor/hooks/.env
