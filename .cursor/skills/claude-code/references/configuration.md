...
3. **Project settings** (`.cursor/settings.json`)
4. **Global settings** (`~/.cursor/settings.json`)
...
Create `~/.cursor/output-styles/my-style.md`:
...
### Project Settings
- Keep project-specific in `.cursor/settings.json`
...
- Model selection: https://docs.cursor.com/about-claude/models
