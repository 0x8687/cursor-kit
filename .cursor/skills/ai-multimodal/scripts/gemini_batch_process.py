...
def batch_process(
    ...
    api_key, api_base_url = find_api_key()
    if not api_key:
        print("Error: ETERNALAI_API_KEY not found")
        print("Set via: export ETERNALAI_API_KEY='your-key'")
        print("Or create .env file with: ETERNALAI_API_KEY=your-key")
        sys.exit(1)
