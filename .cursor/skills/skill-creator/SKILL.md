...
- **Referenced scripts**:
  ...
  - Make sure scripts respect `.env` file follow this order: `process.env` > `.cursor/skills/${SKILL}/.env` > `.cursor/skills/.env` > `.cursor/.env` 
...
- Make sure scripts respect `.env` file follow this order: `process.env` > `.cursor/skills/docs-seeker/.env` > `.cursor/skills/.env` > `.cursor/.env`
...
## References
- [Agent Skills](https://docs.cursor.com/en/docs/claude-code/skills.md)
- [Agent Skills Spec](.cursor/skills/agent_skills_spec.md)
- [Agent Skills Overview](https://docs.cursor.com/en/docs/agents-and-tools/agent-skills/overview.md)
- [Best Practices](https://docs.cursor.com/en/docs/agents-and-tools/agent-skills/best-practices.md)