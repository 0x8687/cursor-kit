...
├── CURSOR.md           # Project-specific Claude instructions
...
**Claude Code Agents** (`.cursor/agents/`):
...
**Skills Organization** (`.cursor/skills/`):
...
**Archived Skills** (`.cursor/skills/_archive/20251104-*/`):
...
**Primary Workflows** (`.cursor/workflows/`):
...
- **CURSOR.md**: Development instructions and workflows
...
### For Agents
- **CURSOR.md**: Primary agent instructions
- **.cursor/workflows/**: Workflow definitions
...
Script: `.cursor/hooks/send-discord.sh`
...
- `/mnt/d/www/claudekit/claudekit-engineer/CURSOR.md` - Agent instructions
...
### Workflows
- `/mnt/d/www/claudekit/claudekit-engineer/.cursor/workflows/primary-workflow.md`
- `/mnt/d/www/claudekit/claudekit-engineer/.cursor/workflows/development-rules.md`
- `/mnt/d/www/claudekit/claudekit-engineer/.cursor/workflows/orchestration-protocol.md`
- `/mnt/d/www/claudekit/claudekit-engineer/.cursor/workflows/documentation-management.md`
